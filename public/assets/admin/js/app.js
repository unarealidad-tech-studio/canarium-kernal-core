...
var App = function() {
    ...
    var uiInit = function() {
        ...
        $('[data-toggle="tabs"] a, .enable-tabs a').click(function(e){ 
            ...
            $('.sidebar-nav ul li').each(function() {
                tmpUri = $('a', this).attr('href');
                tmp_hash = tmpUri.substr(tmpUri.indexOf("#"));

                if (tmp_hash == selected) {
    ...
    var customTabAction = function(hash) {
        $("html, body").animate({ scrollTop: 0 }, "fast");
        $('[data-toggle="tabs"] li a').each(function() {
